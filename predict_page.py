...
def show_predict_page():
    ...
    st.markdown("<h1 style='text-align: center; color: DarkGoldenRod;'>TorqPredX</h1>", unsafe_allow_html=True)
    st.markdown("<h2 style='text-align: center; color: DarkGreen;'> Cloud-enabled Serverless tool for Transient Engine Torque Prediction of Autonomous Tractor </h2>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: left; color: DarkRed;'>Input the following tractor operating parameters for predicting the transient engine torque of tractor : </h3>", unsafe_allow_html=True)
